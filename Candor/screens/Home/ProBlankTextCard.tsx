...
import { MARK_TEXT_BLANK_CARD_AS_PAID } from "../../graphQL/mutations";
import * as WebBrowser from "expo-web-browser";
import ParsedText from "react-native-parsed-text";
import { countris } from "../../utils/countries";

interface ProBlankTextCardProps {
  rbSheetRef: any;
  navigation: any;
  item: any;
  onClose: () => void;
...
export const ProBlankTextCard: FC<ProBlankTextCardProps> = ({
  rbSheetRef,
  navigation,
  onClose,
  ...
  const [MarkCardAsPaid] = useMutation(MARK_TEXT_BLANK_CARD_AS_PAID, {
    async onCompleted(d) {
      console.log(d, "blank text card");
      setLoading(false);
    ...
    async onError(error) {
      console.log(error, "blank text card");
      setLoading(false);
    },
  });
